...
| **B. 云服务器**（阿里云/腾讯云/AWS Lightsail 等，2GB 起） | 想用公网 IP 远程访问的用户 | ⭐⭐ ⚠️ [必读安全章节](#云服务器场景安全防护必读场景-b-用户) |
...
>
> 🔴 **但开放公网前请先看 [云服务器安全防护章节](#云服务器场景安全防护必读场景-b-用户)** —— TeslaMate 主页 `:4000` 默认无认证，直接公网开放任何人都能看你的车辆位置和历史行程。
